...
<body class="bg-white text-gray-900">
    ...
    <div id="hero-section" style="width: 100%; position: relative; background: url('{{ asset('public/images/hero-digital-head.png') }}') lightgray 0px -98.416px / 100% 125.656% no-repeat; margin-top: 60px; margin-bottom: 80px; aspect-ratio: 1920 / 1320;">
