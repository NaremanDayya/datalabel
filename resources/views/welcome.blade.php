                ...
                <div class="relative z-10 hidden lg:block">
                    <div class="relative w-full h-96">
                        <svg class="w-full h-full" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="200" cy="200" r="180" fill="none" stroke="rgba(100, 200, 255, 0.2)" stroke-width="2"/>
                            ...
                            <ellipse cx="200" cy="180" rx="80" ry="100" fill="none" stroke="rgba(0, 200, 255, 0.4)" stroke-width="2"/>
                            <circle cx="170" cy="160" r="8" fill="rgba(100, 200, 255, 0.6)"/>
                            <circle cx="230" cy="160" r="8" fill="rgba(100, 200, 255, 0.6)"/>
                            <circle cx="200" cy="220" r="6" fill="rgba(0, 200, 255, 0.4)"/>
                        </svg>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="rounded-lg overflow-hidden">
                    <div class="bg-gradient-to-br from-gray-300 to-gray-200 h-96 flex items-center justify-center rounded-lg">
                        <div class="text-center text-gray-500">
                            <p class="text-6xl mb-2">👨‍💼📱</p>
                            <p class="text-lg font-semibold">Karama Team</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="workforce" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
                <div class="rounded-lg overflow-hidden">
                    <div class="bg-gradient-to-br from-blue-900 to-blue-800 h-96 flex items-center justify-center rounded-lg">
                        <div class="text-center text-white">
                            <p class="text-6xl mb-2">👩‍💻👨‍💻</p>
                            <p class="text-lg font-semibold">Arabic Annotators</p>
                        </div>
                    </div>
                </div>
    ...
    <footer class="bg-gray-900 text-white py-12">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                <div>
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <span class="font-bold">Karama Data</span>
                    </div>
                    <p class="text-gray-400 text-sm">Arabic AI annotation at scale</p>
                </div>
                <div>
            ...
            <div class="border-t border-gray-800 pt-8 text-center text-sm text-gray-400">
                <p>&copy; 2024 Karama Data. All rights reserved.</p>
            </div>
        </div>
    </footer>
