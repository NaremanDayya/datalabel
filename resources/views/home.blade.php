...
<body class="bg-white text-gray-900">
    ...
    <div style="width: 100%; position: relative; background: #01213D; background-image: url('{{ asset('public/images/Rectangle-76.png') }}'); background-size: contain; background-position: right center; background-repeat: no-repeat; margin-top: 60px; margin-bottom: 80px; aspect-ratio: 1920 / 1320;">
        <div style="width: 100%; height: 100%; position: relative;">
            <div style="width: 50%; left: 5%; top: 15%; position: absolute; color: #FFFFFF; font-size: 70px; font-family: 'Poppins', sans-serif; font-weight: 700; line-height: normal; word-wrap: break-word; z-index: 10;">Your Arabic AI is only as good as the humans who train it .</div>
            <div style="width: 30.7%; left: 8.65%; top: 53.1%; position: absolute; color: #B3B3B3; font-size: 25px; font-family: 'Poppins', sans-serif; font-weight: 400; line-height: normal; word-wrap: break-word; display: flex; align-items: flex-start;">91% accuracy, benchmarked against published research. US-incorporated. No shortcuts.</div>
            ...
            <div data-property-1="Group 113" style="width: 14.6%; height: 14.4%; left: 8.85%; top: 92.8%; position: absolute">
                ...
                <!-- Icon: ix:shield-ai -->
                <div style="width: 16%; height: 23.7%; left: 41.8%; top: 9.5%; position: absolute; display: flex; align-items: center; justify-content: center;">
                    <i class="icon-shield-ai" style="font-size: 28px; color: #548ED3;" data-icon="ix:shield-ai"></i>
                </div>
            </div>
            <div data-property-1="Group 113" style="width: 14.6%; height: 14.4%; left: 25.78%; top: 92.8%; position: absolute">
                <div style="width: 100%; height: 100%; left: 0px; top: 0px; position: absolute; background: linear-gradient(180deg, #043763 8%, #01213D 100%); border-radius: 20px; border: 1px #00427C solid"></div>
                <!-- Icon: lucide:languages -->
                <div style="width: 20%; height: 24%; left: 40%; top: 8%; position: absolute; display: flex; align-items: center; justify-content: center;">
                    <i class="icon-languages" style="font-size: 28px; color: #548ED3;" data-icon="lucide:languages"></i>
                </div>
            ...
            <div data-property-1="Group 113" style="width: 14.6%; height: 14.4%; left: 42.7%; top: 92.8%; position: absolute">
                <div style="width: 100%; height: 100%; left: 0px; top: 0px; position: absolute; background: linear-gradient(180deg, #043763 8%, #01213D 100%); border-radius: 20px; border: 1px #00427C solid"></div>
                <!-- Icon: ix:layers-filled -->
                <div style="width: 20%; height: 24%; left: 40%; top: 8%; position: absolute; display: flex; align-items: center; justify-content: center;">
                    <i class="icon-layers-filled" style="font-size: 28px; color: #548ED3;" data-icon="ix:layers-filled"></i>
                </div>
            ...
            <div data-property-1="Group 113" style="width: 14.6%; height: 14.4%; left: 59.6%; top: 92.8%; position: absolute">
                ...
                <div style="width: 20%; height: 24%; left: 40%; top: 8%; position: absolute; display: flex; align-items: center; justify-content: center;">
                    <i class="icon-global-outlined" style="font-size: 28px; color: #548ED3;" data-icon="ant-design:global-outlined"></i>
                </div>
            ...
            <div data-property-1="Group 113" style="width: 14.6%; height: 14.4%; left: 76.56%; top: 92.8%; position: absolute">
                ...
                <div style="width: 20%; height: 24%; left: 40%; top: 8%; position: absolute; display: flex; align-items: center; justify-content: center;">
                    <i class="icon-chart-no-axes-combined" style="font-size: 28px; color: #548ED3;" data-icon="lucide:chart-no-axes-combined"></i>
                </div>
